...
func (api *InbusClient) GetSemesterFromDate(date string) (*InbusSemester, error) {
...
func (api *InbusClient) GetSubjectVersionFromcode(code string) (*[]*SubjectVersion, error) {
...
func (api *InbusClient) GetConcreteActivities(subjectVersionId uint, semesterId *uint) (*[]*ConcreteActivity, error) {
...
func (api *InbusClient) GetConcreteActivityStudents(concreteActivityId uint) (*[]*StudyRelation, error) {
